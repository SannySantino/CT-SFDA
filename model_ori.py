...
class AdaWarp(nn.Module):
    ...
    def forward(self, x,S=None):
        ...
        if self.stage !='tta': 
            ...
            # output_incompatible=S*output_incompatible+output_compatible             #replace V with S during TTA phase
            output_incompatible=self.V*output_incompatible+S*output_compatible             #replace V with S during TTA phase
